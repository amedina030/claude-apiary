...
class AbortRunTests(unittest.TestCase):
    ...
    @mock.patch.object(abort_mod, "_delete_branches", return_value=[])
    @mock.patch.object(abort_mod, "_remove_worktree", return_value=True)
    def test_abort_corrupt_lockfile(self, mock_wt, mock_br, mock_note):
    ...
    @mock.patch.object(abort_mod, "_delete_branches", return_value=[])
    @mock.patch.object(abort_mod, "_remove_worktree", return_value=True)
    def test_double_abort_skips_existing_archive(self, mock_wt, mock_br, mock_note):
...
class AbortAllTests(unittest.TestCase):
    ...
    @mock.patch.object(abort_mod, "_delete_branches", return_value=[])
    @mock.patch.object(abort_mod, "_remove_worktree", return_value=True)
    def test_abort_all_multiple(self, mock_wt, mock_br, mock_note):
