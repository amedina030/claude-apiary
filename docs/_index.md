...
- [Compass Rule Table](architecture/compass-rules.md) — How the second-person rule table is captured, classified, built, delivered and measured, and the go/no-go on its automation
