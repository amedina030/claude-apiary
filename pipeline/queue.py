#!/usr/bin/env python3
"""List pipeline/* branches ready for review, joined with overnight.jsonl entries."""
from __future__ import annotations
import json, sys
from pathlib import Path
from detached_lib import list_unmerged_pipeline_branches, OVERNIGHT_LOG, SCRIPT_DIR
...
def main() -> int:
    ...
    branches = list_unmerged_pipeline_branches()
    if not branches:
        print('No pipeline/* branches ready for review.')
        return 0
    # Header
