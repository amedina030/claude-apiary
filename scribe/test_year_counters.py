...
class TestPerTypeYearCounters(unittest.TestCase):
    ...
    def test_list_notes_across_years(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            entry2 = {'display_id': f'T-2025-{seq}', 'type': 'todo', 'year': 2025, 'seq': seq, 'status': 'active', 'session': 'sess1', 'timestamp': '2025-06-01T00:00:00+00:00', 'summary': 'old note', 'has_body': True}
