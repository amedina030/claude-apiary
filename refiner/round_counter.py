#!/usr/bin/env python3
"""
Round counter for the refiner skill.
Tracks refinement round count per session to enforce the 15-round limit.
...
TMP_DIR = Path(os.environ.get("REFINER_TMP_DIR", Path(__file__).parent.resolve() / "tmp"))
...
def main():
    parser = argparse.ArgumentParser(description="Refiner round counter")
