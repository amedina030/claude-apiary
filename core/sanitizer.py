...
_RAW_PATTERNS = [
    ...
    ("url-encoded-traversal", _pat(0x25, 0x32, 0x65, 0x25, 0x32, 0x65, 0x25, 0x32, 0x66)),
    # Recursive-force filesystem removal shell invocation
    ("destructive-shell-rm", _pat(0x72, 0x6D, 0x20, 0x2D, 0x72, 0x66)),
    # Classic bash fork-bomb opener
    ("fork-bomb", _pat(0x3A, 0x28, 0x29, 0x7B)),
    # SQL table removal
    ("sql-drop-table", _pat(0x64, 0x72, 0x6F, 0x70, 0x20, 0x74, 0x61, 0x62, 0x6C, 0x65)),
    ...
    ("xss-script-tag", _pat(0x3C, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74)),
    # Browser script URI scheme
    ("xss-javascript-uri", _pat(0x6A, 0x61, 0x76, 0x61, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x3A)),
]
